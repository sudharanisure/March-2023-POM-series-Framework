...
public class ProductInfoPage {
	...
	public int getproductImages() {
		int actProductImages=eleUtil.waitForElementsVisible(productImages, Appconstants.MEDIUM_TIMEOUT_OUT).size();
...
//	Availability: In Stock
	private void getProductMetaData() {
		List<WebElement> metaList=eleUtil.waitForElementsVisible(productMetaData, Appconstants.MEDIUM_TIMEOUT_OUT);
...
//		return metaMap;
	...
	private void getProductPriceData() {
		List<WebElement> priceList = eleUtil.waitForElementsVisible(productPriceData, Appconstants.MEDIUM_TIMEOUT_OUT);
		...
		public Map<String, String> getProductData() {
			...
			//productMap = new TreeMap<String, String>(); following some sorting order
